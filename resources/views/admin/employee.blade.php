...
<div class="bgded overlay" style="background-image:url('{{asset('./images/demo/backgrounds/a4.jpg')}}');">
                    ...
                    <div class="card-header">
                        ...
                        <div align="center">
                            <a href="{{ route('addemployee') }}">
                                {!! Form::button('เพิ่มข้อมูลพนักงาน',['type' => 'submit', 'class'=>'btn btn-outline-primary']); !!}
                            </a>
                        </div>
                    </br>
    ...
    <script>
        ...
        document.getElementById('emps').classList.add('active');
            $('#example').DataTable();
        });
