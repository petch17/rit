...
<center>
    ...
    <td style="border:1px dashed white;" bgcolor="white"><img src="{{ asset('images/demo/backgrounds/a5.jpg') }}" height="400" width="400">
        <table width=90% cellpadding="4" cellspacing="0" style="border:double 0px rgb(105, 183, 255);"><tr><td style="border:double 5px hotpink;">1.บริการตัดปาล์ม คิดเป็นกิโลละ 3 บาท ตัดได้กี่กิโลกรัมเอามา * 3 (แล้วหักค่ามัดจำ 30% ) (อีก 70 % เป็นของลูกค้า)</td></tr></table>
        <br><br><br><br><br>
